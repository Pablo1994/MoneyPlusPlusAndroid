...
public class IngresaGasto extends Base {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ingresa_gasto, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    fragment = new tabGastoUnico();
                    break;
                case 1:
                    fragment= new tabGastoDiario();
                    break;
                case 2:
                    fragment= new tabGastoPeriodico();
                    break;
            }
            return fragment;
        }
